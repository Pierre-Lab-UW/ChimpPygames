    ...
    def check_for_progression(self):
        ...
        if not self.progressed:
            ...
            with open(self.filepath_to_progress, 'r') as f:
                ...
                trials_to_check_criterion = int(self.m_params[self.monkey_name]['MTSseqttrials'])
                trials_to_achieve_criterion = int(self.m_params[self.monkey_name]['MTSseqtcriterion'])
